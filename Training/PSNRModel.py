...
class PSNRModel(BaseModel):
    ...
    def __init__(self, r = 2, N = 10, L = 2, dataset_str = None, cutoff=sys.maxsize, epochs=20, norm_fn='group', memory_buffer_length=2,
        ...
        super(PSNRModel, self).__init__(r, N, L, dataset_str, cutoff, epochs, norm_fn, memory_buffer_length,
...
if __name__ == '__main__':
    ...
    test_TOYOTA = PSNRModel(dataset_str="TOYOTA", cutoff=3, epochs = 1)
    test_TOYOTA.forward_loss_psnr()